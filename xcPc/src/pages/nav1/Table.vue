    ...
    <Row :gutter="16">
      ...
      <i-col :span="5" gutter="16" style="margin-top:16px">
        <Card style="height:630px">
          ...
          <Scroll :on-reach-bottom="handleReachBottom" height="500" style="margin:10px 0;">
            <i-col
              dis-hover
      ...
      <!-- 右边动态数据 -->
      <i-col :span="19">
        <Card style="margin-top:16px;height:630px;overflow:auto;">
          <div class="tabs_div" style="height:30px;position: relative">
            ...
            <Tabs style="overflow-y: auto" :animated="false" :value="checkTab" @on-click="flagTab">
                ...
                <Card>
                  ...
                  <div style="margin-bottom:50px;position: relative">
                    ...
                    <div
                      class="callDetail"
                      v-if="this.echartsIsShow"
                      style="position: absolute;left: 70%;top: 150px"
                    >
                  ...
                  <div v-if="!this.echartsIsShow" class="activeEchart">
                    <img src="../../assetss/images/noData.png" alt />
                  </div>
                  <!-- </i-col> -->
                </Card>
              </Tab-pane>
                  ...
                  <Row style="margin-top:10px">
                    <Form :model="gadList" :label-width="85" label-position="right">
                      <Row :gutter="30">
                        ...
                        <Col span="2" style="margin-top:8px;font-size:12px" offset="2">
                      ...
                      <div v-if="isMoreSearch">
                        ...
                        <Col span="5" style>
                          <Form-item label :label-width="25">
                            <DatePicker
                        ...
                        <Col span="6" style>
                          <Form-item label="通话状态" class="item">
                            <i-select
                              v-model="gadList.closeresult"
                              placeholder="通话状态"
                              style=""
                            >
        ...
        <i-col>
          <i-col style="display:flex;justify-content:space-around;">
            ...
            <div style="margin-top:13px">
              跟进状态:
              <Button type="info" size="small" ghost class="ghost">进行中</Button>
            </div>
          </i-col>
          <i-col
...
export default {
  ...
  data() {
    return {
      isTitle: true,
      titleMsg: "24-31号期间暂停外呼，给您带来不便，深表歉意!",
      createTime: "", //任务 通话记录创建时间
  ...
  methods: {
    ...
    callDetails(sleectEle) {
      ...
      this.createTime = sleectEle.createtime ? sleectEle.createtime : "";
      if (this.createTime) {
        //获取三个月后时间
    ...
    getSurplusOccursTotal() {
      getSurplusOccurs().then(res => {
        ...
        if (res.code == "10000") {
          ...
          this.formItem.occurs1 = res.content.surplusOccurs;
          console.log(this.formItem.occurs1);
          this.maxNum.useOccurs = res.content.useOccurs;
          this.maxRobot = res.content.surplusOccurs;
          if (this.maxNum.useOccurs >= 1) {
            this.formItem.occurs = 1;
          }
        }
      });
    },
    ...
    addSurplusOccurs() {
      ...
      } else if (!reg.test(this.formItem.taskname)) {
        this.$Message.error({
          content: "任务名称仅支持中英文、数字",
          top: 50,
          duration: 3
        });
        return false;
    ...
    // 下载示例文件
    downloadSampleFiles() {
      let url = `${this.common.common.baseUrlPort}manage/toloadexcleCustomer?Authorization=${this.userInfo.token}`;
    ...
    exportCallRecord() {
      ...
      let stime = this.gadList.stime ? this.formatDate(this.gadList.stime) : "";
      let etime = this.gadList.etime ? this.formatDate(this.gadList.etime) : "";
      let array =
      ...
      //         pageSize: 10,
      //         pageNo: 1,
      //         closeresult: this.gadList.closeresult ? this.gadList.closeresult : "",
      ...
      &maxCallTime=${this.gadList.sTimeLong}
      &Authorization=${this.userInfo.token}&taskname=${
        this.formItem.taskname
      }&stime=${stime}&etime=${etime}&closeresult=${
        this.gadList.closeresult ? this.gadList.closeresult : ""
      }
      &level=${this.gadList.iclevelname.join(",")}`;
      window.location.href = url;
      // } else {
    ...
    addTaskBtn() {
      if (!this.isTitle) {
        this.$Message.info(this.titleMsg);
        return;
      }
      this.formItem.occurs = this.formItem.occurs1;
      this.getSurplusOccursTotal();
    ...
    editTaskBtn() {
      ...
      getOneTask(data).then(res => {
        if (res.code == "10000") {
          ...
          //大于等于1为1，为0 就为 0
          // this.formItem.occurs = Number(this.maxNum.surplusOccurs)>1||Number(this.maxNum.surplusOccurs)==1?1:0
    ...
    hideEven() {
      ...
      let data = {
        ...
        taskid: this.selectCallData.taskid,
        salenum: this.selectCallData.salenum,
        closeresult: this.gadList.closeresult || "",
        level: this.gadList.iclevelname.join(","),
        saleid: this.gadList.saleid,
        stime: this.gadList.stime ? this.formatDate(this.gadList.stime) : "",
        etime: this.gadList.etime ? this.formatDate(this.gadList.etime) : ""
      };
      //       ztCustomerTm.mobilephone:
      // isread:
      // minCallTime:
      // maxCallTime:
      // calltype: 3
    ...
    getTaskDetail(e, index) {
      ...
      this.echartsIsShow = this.pieData.some(item => item.value !== 0);
      console.log(this.echartsIsShow);
