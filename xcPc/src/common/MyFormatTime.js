...
/**
 * 获取当前日期（2019-01-10 格式）
 */
export function getNowDate() {
  let date = new Date()
  let Y = date.getFullYear()
  // let M = (date.getMonth() + 1 < 10 ? '0' + (date.getMonth() + 1) : date.getMonth() + 1)
  // let M = date.getMonth().formatNumber()+1
  let M = date.getMonth() + 1
  let D = date.getDate().formatNumber()
  if (M < 10) {
    M = "0" + M;
  }
  // return `${Y}年${M}月${D}日`
...
/**
 * 格式化传入的日期（2019-01-10 格式）
 */
export function setSelectDate(date) {
  let Y = date.getFullYear()
  // let M = (date.getMonth() + 1 < 10 ? '0' + (date.getMonth() + 1) : date.getMonth() + 1)
  // let M = date.getMonth().formatNumber()+1
  let M = date.getMonth() + 1
 ...
 * 格式化传入的日期（2019-01-10 格式）
 */
export function setSelectSecond(date) {
   date = new Date(date)
  let Y = date.getFullYear()
  // let M = (date.getMonth() + 1 < 10 ? '0' + (date.getMonth() + 1) : date.getMonth() + 1)
  // let M = date.getMonth().formatNumber()+1
